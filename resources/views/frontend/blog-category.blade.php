...
<section class="section wb">
    <div class="container">
        <div class="section-title">
            <h3 class="color-aqua"><a href="blog-category-01.html" title="">{{$category->cat_name}}</a></h3>
        </div><!-- end title -->
        <div class="row">
                ...
                <div class="content-post-container">
                    <div class="post-author--wrapper" style="margin: 0.5rem 0.5rem">
                        ...
                        <div class="post-author--infor">
                            <a class="post-author--name" href="/user/{{$blog->author_name->id}}" style="color: #000000;"><b>{{$blog->author_name->user_account}}</b></a>
                    ...
                    <div class="content-post-content">
                        <h3 class="content-post-header" style="font-size: 18px; margin: 10px 0px">
                            <a href="/new-post/{{$blog->id}}">
                                {{$blog->blog_heading}}
                            </a>
                        </h3>
