    ...
    <div class="row">
        <div class="col-lg-9 col-md-12 col-sm-12 col-xs-12">
            <div class="page-wrapper">
                ...
                <form action="" id="post_a_status" class="needs-validation">
                    <div class="mb-3 mt-3">
                      <b><label for="heading">Tiêu đề :</label></b>
                      <input type="text" placeholder="Nhập tiêu đề" name="heading" id="heading" class="form-control mt-2 mb-3" required>
                      <label for="category">Chủ đề :</label>
                      <div class="form-floating mb-3 mt-2">
                        <select class="form-select" id="category" name="category" style="height: 38px; margin : 1px" >
                      ...
                      <textarea placeholder="Nhập nội dung ..." class="form-control mb-3 mt-2" rows="5" id="post-content" name="text" required></textarea>
                    </div>
