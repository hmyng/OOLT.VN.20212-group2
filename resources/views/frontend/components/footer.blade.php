                    ...
                    <div class="col-lg-8 offset-lg-2">
                        <div class="widget">
                            <div class="footer-text text-center">
                                <a href="/home"><img src="{{asset('cloapedia/images/gau-icon.png')}}" alt="" style="width: 20%" class="img-fluid"></a>
                                ...
                                <div class="social">
                                    ...
                                    <a href="#" data-toggle="tooltip" data-placement="bottom" title="Twitter"><i class="fa fa-youtube"></i></a>
